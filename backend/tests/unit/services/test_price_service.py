...
class TestGetPriceSummary:
    ...
    async def test_existing_component_returns_summary(
        ...
        expected = PriceSummarySchema(
            component="DRAM", market_segment="SERVER", period_days=30,
            avg_price=Decimal("4.25"), min_price=Decimal("4.00"),
            max_price=Decimal("4.50"), latest_price=Decimal("4.50"),
            price_unit="USD_PER_GB", currency="USD",
            price_change_pct=Decimal("5.00"), data_points=120,
